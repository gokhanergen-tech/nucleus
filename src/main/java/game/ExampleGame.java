...
import nucleus.core.models.*;
import nucleus.core.models.terrain.BlendMapTerrain;
import nucleus.core.models.terrain.Terrain;
import nucleus.core.models.terrain.TerrainTexture;
import nucleus.core.rendering.RenderManager;
...
public class ExampleGame implements ILogic {
    ...
    @Override
    public void init(WindowManager windowManager) throws Exception {
