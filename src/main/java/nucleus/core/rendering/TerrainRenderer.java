...
import static nucleus.utils.Consts.*;
import nucleus.utils.Transformation;
...
public class TerrainRenderer implements IRenderer{
    ...
    public void render(Camera camera, DirectionalLight directionalLight, PointLight[] pointLights, SpotLight[] spotLights) {
        shaderManager.bind();
        shaderManager.setUniform("projectionMatrix", NucleusApp.getWindowManager().updateProductionMatrix());
